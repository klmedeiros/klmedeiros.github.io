...
###Current
- Kaelen is currently for hire! Contact them at kaelenmedeiros at gmail dot com.
...
- Develop metrics to guide product team and individual product squads.
- Build and maintain dashboard of product metrics, plus own relevant product sections of other company dashboards.
- Maintain and develop product-related data views in company data lake, built with R or Redshift SQL and executed using CircleCI and Airflow.
- Conduct ad-hoc analyses for squads and product research on user behavior.
- Design and analyze product A/B tests with product managers and company-wide experimentation team.

####DataCamp : Content Quality Data Scientist
#####May 2018 - March 2019
...
- *RETRACTED: Impact of Cooperative Trial and Sociodemographic Variation on Adjuvant Radiation Therapy Usage in Elderly Women (≥70 Years) with Stage I, Estrogen Receptor-Positive Breast Cancer: Analysis of the National Cancer Data Base.* Chu QD, **Medeiros KL**, Zhou M, Peddi P, Wu XC. *J Am Coll Surg*. 2016 Apr;222(4):667-78. Epub 2016 Jan 27. [Link](https://www.journalacs.org/article/S1072-7515(15)01809-8/pdf).
    - This was retracted due to an error on the part of all the authors. One of the variables was not collected for all of the years we thought it had been, and we therefore had to issue a retraction.
