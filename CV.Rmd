...
#####March 2019 - Present
- Responsible for metric tracking on the Campus app (where learners take courses) plus the mobile and practice apps.
- Help design A/B tests and other product experiments for those two teams.
- Maintain an internal Shiny dashboard tracking product metrics.
